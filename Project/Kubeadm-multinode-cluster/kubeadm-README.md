1. Deploy 3 VM's in any platform
2. Create security group to open the firewall port
3. Allow the port in Control plane security group
4. Allow the port in Worker node security port
5. 
